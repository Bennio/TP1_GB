...
public class Transactions {
	...
	public Transactions(int numTransaction, Integer idClient, Integer idCompte, Date dateTransaction,
			String typeTransaction, Double montantTransaction, Double solde_Av_T, Double solde_Ap_T) {
